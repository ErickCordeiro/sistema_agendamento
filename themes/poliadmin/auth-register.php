...
<aside class="main_content_box">
    ...
    <form class="form_login" action="<?= url("/admin/registrar") ?>" method="post" enctype="multipart/form-data">
        ...
        <button class="btn btn-green radius transition"> Cadastrar Usuário</button>
    </form>
